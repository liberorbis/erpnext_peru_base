    ...
    install_docs = [
        ...
        #TABLE 01 - SUNAT
         ...
         'element_tables':[
             ...
             {'name':'EFECTIVO,NO OBLIGADO A MEDIOS DE PAGO', 'element_code':'008', 'element_code2':'','field_name':'EFECTIVO,NO OBLIGADO A MEDIOS DE PAGO', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'EFECTIVO, EN LOS DEMÁS CASOS','active':1},
             ...
             {'name':'MEDIOS DE PAGO DE CE', 'element_code':'010', 'element_code2':'','field_name':'MEDIOS DE PAGO DE COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1},
             ...
             {'name':'TRANSFERENCIAS - CE', 'element_code':'101', 'element_code2':'','field_name':'TRANSFERENCIAS - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1},
             {'name':'CHEQUES BANCARIOS - CE', 'element_code':'102', 'element_code2':'','field_name':'CHEQUES BANCARIOS - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1},
             {'name':'ORDEN DE PAGO SIMPLE - CE', 'element_code':'103', 'element_code2':'','field_name':'ORDEN DE PAGO SIMPLE - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1},
             {'name':'ORDEN DE PAGO DOCUMENTARIO - CE', 'element_code':'104', 'element_code2':'','field_name':'ORDEN DE PAGO DOCUMENTARIO - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1},
             {'name':'REMESA SIMPLE - CE', 'element_code':'105','element_code2':'','field_name':'REMESA SIMPLE - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1},
             {'name':'REMESA DOCUMENTARIA - CE', 'element_code':'106','element_code2':'','field_name':'REMESA DOCUMENTARIA - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1},
             {'name':'CARTA DE CREDITO SIMPLE - CE', 'element_code':'107','element_code2':'','field_name':'CARTA DE CREDITO SIMPLE - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1},
             {'name':'CARTA DE CREDITO DOCUMENTARIO-CE', 'element_code':'108','element_code2':'','field_name':'CARTA DE CREDITO DOCUMENTARIO - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1},
        ...
        {'doctype':'Table Sunat', 'name':'T02','field_name':'TIPOS DE MEDIO DE PAGO','code':'TABLA_02', 'active':1,
         'element_tables':[
             ...
             {'name':'RUC', 'element_code':'06','element_code2':'','field_name':'REGISTRO UNICO DE CONTRIBUYENTE', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'REGISTRO UNICO DE CONTRIBUYENTES','active':1,},
        ...
        {'doctype':'Table Sunat', 'name':'T10','field_name':'TIPO DE COMPROBANTE DE PAGO O DOCUMENTO','table_code':'TABLA_10', 'active':1,
         ...
         'element_tables':[
             ...
             {'name':'Boleto de empresas de trans. publico', 'element_code':'15','element_code2':'','field_name':'Boleto emitido por las empresas de transporte público urbano de pasajeros', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1,},
             {'name':'Boleto transporte público interprovincial', 'element_code':'16','element_code2':'','field_name':'Boleto de viaje emitido por las empresas de transporte público interprovincial de pasajeros dentro del país', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1,},
             {'name':'Documento Iglesia Católica por el arrendamiento', 'element_code':'17','element_code2':'','field_name':'Documento emitido por la Iglesia Católica por el arrendamiento de bienes inmuebles', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1,},
             {'name':'Documento emitido por AFP', 'element_code':'18','element_code2':'','field_name':'Documento emitido por las Administradoras Privadas de Fondo de Pensiones', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'Documento emitido por las Administradoras Privadas de Fondo de Pensiones que se encuentran bajo la supervisión de la Superintendencia de Administradoras Privadas de Fondos de Pensiones','active':1,},
             {'name':'Boletos espectáculos públicos', 'element_code':'19','element_code2':'','field_name':'Boleto o entrada por atracciones y espectáculos públicos', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1,},
             ...
             {'name':'Conocimiento de embarque trans.carga marítima', 'element_code':'21','element_code2':'','field_name':'Conocimiento de embarque por el servicio de transporte de carga marítima', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1,},
             ...
             {'name':'Certificado de pago de regalías PERUPETRO S.A', 'element_code':'24','element_code2':'','field_name':'Certificado de pago de regalías emitidas por PERUPETRO S.A', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1,},
             ...
             {'name':'Declaración Única de Aduanas - Imp. def.', 'element_code':'50','element_code2':'','field_name':'Declaración Única de Aduanas - Importación definitiva', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1,},
             {'name':'Despacho Simplificado - Imp. Simp.', 'element_code':'52','element_code2':'','field_name':'Despacho Simplificado - Importación Simplificada', 'val_porcent':0,'val_float':0,'val_string':'','desciption':'','active':1,},
