...
def tables_sunat_after_install():
    install_docs = [
        ...
        #TABLE 01 - SUNAT
         {'doctype':'Table Sunat', 'name':'T01','field_name':'TIPOS DE MEDIO DE PAGO','code':'TABLA_01', 'active':1,
         'element_tables':[
             ...
             {'name':'CHEQUES BANCARIOS - CE', 'element_code':'102', 'element_code2':'','field_name':'CHEQUES BANCARIOS - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','description':'','active':1},
             {'name':'ORDEN DE PAGO SIMPLE - CE', 'element_code':'103', 'element_code2':'','field_name':'ORDEN DE PAGO SIMPLE - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','description':'','active':1},
             {'name':'ORDEN DE PAGO DOCUMENTARIO - CE', 'element_code':'104', 'element_code2':'','field_name':'ORDEN DE PAGO DOCUMENTARIO - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','description':'','active':1},
             {'name':'REMESA SIMPLE - CE', 'element_code':'105','element_code2':'','field_name':'REMESA SIMPLE - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','description':'','active':1},
             {'name':'REMESA DOCUMENTARIA - CE', 'element_code':'106','element_code2':'','field_name':'REMESA DOCUMENTARIA - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','description':'','active':1},
             {'name':'CARTA DE CREDITO SIMPLE - CE', 'element_code':'107','element_code2':'','field_name':'CARTA DE CREDITO SIMPLE - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','description':'','active':1},
             {'name':'CARTA DE CREDITO DOCUMENTARIO-CE', 'element_code':'108','element_code2':'','field_name':'CARTA DE CREDITO DOCUMENTARIO - COMERCIO EXTERIOR', 'val_porcent':0,'val_float':0,'val_string':'','description':'','active':1},
         ...
         #TABLE 02 - SUNAT
        {'doctype':'Table Sunat', 'name':'T02','field_name':'TIPOS DE MEDIO DE PAGO','code':'TABLA_02', 'active':1,
         'element_tables':[
             ...
             {'name':'RUC', 'element_code':'06','element_code2':'','field_name':'REGISTRO UNICO DE CONTRIBUYENTE', 'val_porcent':0,'val_float':0,'val_string':'','description':'REGISTRO UNICO DE CONTRIBUYENTES','active':1,},
        ...
        {'doctype':'Table Sunat', 'name':'T10','field_name':'TIPO DE COMPROBANTE DE PAGO O DOCUMENTO','code':'TABLA_10', 'active':1,
         ...
         'element_tables':[
             ...
             {'name':'Boleto transporte público interprovincial', 'element_code':'16','element_code2':'','field_name':'Boleto de viaje emitido por las empresas de transporte público interprovincial de pasajeros dentro del país', 'val_porcent':0,'val_float':0,'val_string':'','description':'','active':1,},
             ...
             {'name':'Certificado de pago de regalías PERUPETRO S.A', 'element_code':'24','element_code2':'','field_name':'Certificado de pago de regalías emitidas por PERUPETRO S.A', 'val_porcent':0,'val_float':0,'val_string':'','description':'','active':1,},
