...
def tables_sunat_after_install():
    install_docs = [
        ...
        #TABLE 01 - SUNAT
         ...
         {'doctype':'Table Sunat', 'name':'TIPOS DE MEDIO DE PAGO','field_name':'TIPOS DE MEDIO DE PAGO','code':'TABLA_01', 'active':1,'parent_table_sunat':_('TABLAS_SUNAT'),
         'element_tables':[
         ...
         #TABLE 02 - SUNAT
        {'doctype':'Table Sunat', 'name':'TIPOS DE MEDIO DE PAGO','field_name':'TIPOS DE MEDIO DE PAGO','code':'TABLA_02', 'active':1,
         'element_tables':[
        ...
        #{'doctype':'table_sunat', 'name':'TIPO DE OPERACION','field_name':'TIPO DE OPERACION','table_code':'TABLA_12', 'active':1,'parent_table_sunat':_('TABLAS_SUNAT')},
         {'doctype':'Table Sunat', 'name':'TIPOS DE MEDIO DE PAGO','field_name':'TIPOS DE MEDIO DE PAGO','code':'TABLA_1', 'active':1,'parent_table_sunat':_('TABLAS_SUNAT'),
         'element_tables':[
        ...
        {'doctype':'Table Sunat', 'name':'T10','field_name':'TIPOS DE MEDIO DE PAGO','code':'TABLA_10', 'active':1,'parent_table_sunat':_('TABLAS_SUNAT'),
         'element_tables':[
